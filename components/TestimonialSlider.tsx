      ...
      <div className="max-w-3xl mx-auto px-4 relative z-10">
          ...
          {typeof window !== 'undefined' ? (
            <AnimatePresence mode="wait">
              {testimonial && (
                ...
                {/* Quote */}
                <p className="text-xl italic text-purple-900/90 mb-6 luxury-font-serif">
                  &ldquo;{testimonial.quote}&rdquo;
                </p>
                {/* Name & City */}
                <div className="flex flex-col items-center gap-1">
                  <span className="font-bold text-lg text-gray-900 tracking-wide luxury-font-serif">
                    {testimonial.name}
                  </span>
                  <span className="text-sm text-purple-700 luxury-font-sans">{testimonial.role}</span>
                </div>
              </MotionDiv>
              )}
            </AnimatePresence>
        ...
        {typeof window !== 'undefined' ? (
          <MotionDiv
            ...
            transition={{ delay: 1 }}
          >
            <MotionDiv animate={{ x: [0, 5, 0] }} transition={{ duration: 2, repeat: Infinity }}>
              ←
            </MotionDiv>
          ...
          <div className="md:hidden mt-6 text-sm text-gray-500 flex items-center gap-2 justify-center">
            <span>←</span>
            <span>Swipe to read more</span>
            <span>→</span>
          </div>
