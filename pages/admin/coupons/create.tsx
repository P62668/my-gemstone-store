...
const CreateCouponPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await apiClient.post('/api/coupons', {
      ...
      if (res.ok) {
        ...
        const errorMsg = (res.data as any)?.error || 'Failed to create coupon';
        throw new Error(errorMsg);
      }
    } catch (err: any) {
      const errorMsg = err.message || 'Error creating coupon';
      setError(errorMsg);
  ...
  if (userLoading || !isClient) {
    return (
      <Layout title="Create Coupon - Shankarmala Gemstore">
  ...
  return (
    <Layout title="Create Coupon - Shankarmala Gemstore">
      <Head>
        <title>Create Coupon - Shankarmala Gemstore</title>
      </Head>
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="px-6 py-8 sm:p-8">
              <div className="mb-8">
                ...
                <p className="mt-2 text-gray-600">Create a discount coupon for your customers</p>
              </div>
